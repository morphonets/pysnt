...
This script automatically generates .rst files for all modules in the PySNT package.
"""
...
def create_api_index():
    ...
    api_dir = Path(__file__).parent / "api_auto"
...
if __name__ == "__main__":
    ...
    if generate_api_docs():
        create_api_index()
        print("\n💡 To include in your documentation, add 'api_auto/index' to your toctree")
    else:
