...
Enhanced documentation for MouseLightQuerier class.
...
.. py:method:: static getIDs(Collection, boolean))
...
* `Main API Documentation <../../api_auto/pysnt.io#MouseLightQuerier>`_
* `MouseLightQuerier JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/MouseLightQuerier.html>`_
