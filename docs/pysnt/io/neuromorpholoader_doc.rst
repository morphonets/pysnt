...
Enhanced documentation for NeuroMorphoLoader class.
...
.. py:method:: enableSourceVersion(boolean))
...
* `Package API <../../api_auto/pysnt.io.html#pysnt.io.NeuroMorphoLoader>`_
* `Main API Documentation <../../api_auto/pysnt.io#NeuroMorphoLoader>`_
* `NeuroMorphoLoader JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/NeuroMorphoLoader.html>`_
