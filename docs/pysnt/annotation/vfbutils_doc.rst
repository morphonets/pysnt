...
Enhanced documentation for VFBUtils class.
...
.. py:method:: static getMesh(String))
...
* `Main API Documentation <../../api_auto/pysnt.annotation#VFBUtils>`_
* `VFBUtils JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/VFBUtils.html>`_
