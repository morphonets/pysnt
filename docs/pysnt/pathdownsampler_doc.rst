...
``PathDownsampler`` Class Documentation
====================================
...
* `Package API <../api_auto/pysnt.html#pysnt.PathDownsampler>`_
* `PathDownsampler JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/PathDownsampler.html>`_
