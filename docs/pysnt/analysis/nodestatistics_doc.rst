...
Enhanced documentation for NodeStatistics class.
...
.. py:method:: getAnnotatedHistogram(int))
...
* `Main API Documentation <../../api_auto/pysnt.analysis#NodeStatistics>`_
* `NodeStatistics JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/NodeStatistics.html>`_
