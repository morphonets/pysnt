...
Enhanced documentation for PathStatistics class.
...
* `Main API Documentation <../../api_auto/pysnt.analysis#PathStatistics>`_
* `PathStatistics JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/PathStatistics.html>`_
