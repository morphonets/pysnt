...
Enhanced documentation for PointInImage class.
...
* `Main API Documentation <../../api_auto/pysnt.util#PointInImage>`_
* `PointInImage JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/PointInImage.html>`_
