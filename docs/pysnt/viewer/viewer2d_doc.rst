...
Enhanced documentation for Viewer2D class.
...
* `Main API Documentation <../../api_auto/pysnt.viewer#Viewer2D>`_
* `Viewer2D JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/Viewer2D.html>`_
