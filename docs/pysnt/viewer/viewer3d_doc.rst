...
Enhanced documentation for Viewer3D class.
...
.. py:method:: addColorBarLegend(ColorTable, double, double, boolean))
...
.. py:method:: colorCode(String, String, ColorTable))
...
* `Main API Documentation <../../api_auto/pysnt.viewer#Viewer3D>`_
* `Viewer3D JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/Viewer3D.html>`_
