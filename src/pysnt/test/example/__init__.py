...
Note: Placeholder classes are now generated automatically by setup_module_classes()!
Example:
...
`SNT's example classes <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/test/example/package-summary.html>`__.

Replace example and test/example with your module information.
Examples:
...
_module_funcs = setup_module_classes(
    package_name="sc.fiji.snt.test.example",  # Edit this: e.g., "sc.fiji.snt.analysis.morphology"
...
__getattr__ = _module_funcs['create_getattr']('pysnt.test.example')  # Edit this: e.g., 'pysnt.analysis.morphology'
...
# __getattr__ = _module_funcs['create_getattr']('pysnt.test.example', submodules=['submodule1', 'submodule2'])
