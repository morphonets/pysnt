...
`SNT's image classes <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/tracing/image/package-summary.html>`__.
"""
...
class ArraySearchImage:
    """
    Curated SNT class from tracing/image package with method signatures.
...
__getattr__ = _module_funcs["create_getattr"]("pysnt.tracing.image")
