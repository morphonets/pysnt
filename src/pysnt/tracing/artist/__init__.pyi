...
class BiSearchArtist:
    """
    BiSearchArtist - No cached signatures available.
...
class FillerThreadArtist:
    """
    FillerThreadArtist - No cached signatures available.
...
class SearchArtistFactory:
    """
    SearchArtistFactory - No cached signatures available.
...
class SearchThreadArtist:
    """
    SearchThreadArtist - No cached signatures available.
