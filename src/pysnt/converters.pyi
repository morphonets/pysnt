...
def _show_pandasgui_dataframe(df: Any, title: str, **kwargs: Any) -> bool: ...
...
def _detect_object_type(obj: Any) -> tuple: ...

def _display_array_data(data: Any, source_type: str, **kwargs: Any) -> Any: ...
