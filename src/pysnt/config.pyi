...
class _Option:
    def __init__(self: Any, key: str, default_value: Any, doc: str, validator: Optional[Callable]) -> Any: ...
...
def _register_option(key: str, default_value: Any, doc: str, validator: Optional[Callable]) -> Any: ...
