...
class LinearProfileStats:
    """
    LinearProfileStats - No cached signatures available.
...
class NormalizedProfileStats:
    """
    NormalizedProfileStats - No cached signatures available.
...
class PolarProfileStats:
    """
    PolarProfileStats - No cached signatures available.
...
class ShollStats:
    """
    ShollStats - No cached signatures available.
