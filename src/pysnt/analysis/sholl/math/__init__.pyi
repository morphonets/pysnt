...
class PolarProfileStats:
    """
    SNT PolarProfileStats class with complete method signatures.
    Generated using Java reflection.
    """
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, arg0: Any, arg1: float) -> None: ...
    @overload
    def __init__(self, arg0: Any, arg1: Any, arg2: float) -> None: ...
    @overload
    def __init__(self, arg0: Any) -> None: ...
    ...
    # Methods
    def appendSummaryReport(self, arg0: Any) -> None: ...
    def detailReport(self, arg0: Any) -> None: ...
    @overload
    def findDirectionPeaks(self, arg0: float, arg1: float, arg2: int, arg3: float) -> List[Any]: ...
    @overload
    def findDirectionPeaks(self, arg0: float, arg1: float) -> List[Any]: ...
    @overload
    def findOrientationPeaks(self, arg0: float, arg1: float, arg2: int, arg3: float) -> List[Any]: ...
    @overload
    def findOrientationPeaks(self, arg0: float, arg1: float) -> List[Any]: ...
    def getAngleStepSize(self) -> float: ...
    @overload
    def getAngularDistribution(self) -> List[float]: ...
    @overload
    def getAngularDistribution(self, arg0: float, arg1: float) -> List[float]: ...
    def getAngularDistributionCoherence(self) -> float: ...
    def getDataMode(self) -> Any: ...
    @overload
    def getFitYValues(self) -> List[float]: ...
    @overload
    ...
    def getN(self) -> int: ...
    def getOrientationDistributionCoherence(self) -> float: ...
    @overload
    def getPlot(self) -> Any: ...
    @overload
    def getPlot(self, arg0: str) -> Any: ...
    @overload
    def getPlot(self, arg0: Any) -> Any: ...
    @overload
    def getPreferredDirection(self, arg0: float, arg1: float) -> float: ...
    @overload
    def getPreferredDirection(self) -> float: ...
    @overload
    def getPreferredOrientation(self) -> float: ...
    @overload
    def getPreferredOrientation(self, arg0: float, arg1: float) -> float: ...
    def getProfile(self) -> Any: ...
    ...
    @overload
    def getYValues(self) -> List[float]: ...
    def setAngleStepSize(self, arg0: float) -> None: ...
    def setDataMode(self, arg0: Any) -> None: ...
    def validFit(self) -> bool: ...
