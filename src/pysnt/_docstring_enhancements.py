...
def enhance_class_docstrings():
    ...
    enhanced_docstrings = {
        ...
        "NodeProfiler": '"""\n    Command to retrieve node profiles (plots of voxel intensities sampled across Path nodes).\n    \n    **All Methods and Attributes:** See `NodeProfiler detailed documentation </nodeprofiler_doc.html>`_.\n    """',
        "SNTTable": '"""\n    Extension of DefaultGenericTable with (minor) scripting conveniences.\n    \n    **All Methods and Attributes:** See `SNTTable detailed documentation </snttable_doc.html>`_.\n    """',
        "PathChangeListener": '"""\n    SNT class with method signatures.\n    \n    Available for direct import after JVM initialization.\n    Call pysnt.initialize() before using this class.\n    \n    **All Methods and Attributes:** See `PathChangeListener detailed documentation </pathchangelistener_doc.html>`_.\n    \n    See `PathChangeListener JavaDoc <https://javadoc.scijava.org/SNT/index.html?sc/fiji/snt/PathChangeListener.html>`_.\n    """',
        "ImpUtils": '"""\n    Static utilities for handling and manipulation of ImagePluss\n    \n    **All Methods and Attributes:** See `ImpUtils detailed documentation </imputils_doc.html>`_.\n    """',
        "ImgUtils": '"""\n    Static utilities for handling and manipulation of `RandomAccessibleInterval`s\n    \n    **All Methods and Attributes:** See `ImgUtils detailed documentation </imgutils_doc.html>`_.\n    """',
        ...
        "VFBUtils": '"""\n    Utility methods for accessing/handling Virtual Fly Brain (VFB) annotations\n    \n    **All Methods and Attributes:** See `VFBUtils detailed documentation </vfbutils_doc.html>`_.\n    """',
        ...
        "ShollAnalyzer": '"""\n    Class to retrieve Sholl metrics from a Tree.\n    \n    **All Methods and Attributes:** See `ShollAnalyzer detailed documentation </shollanalyzer_doc.html>`_.\n    """',
        ...
        "MultiTreeColorMapper": '"""\n    Class for color coding groups of Trees.\n\nAfter a mapping property and a color table (LUT) are specified, the mapping proceeds as follows: 1) Each Tree in the group is measured for the mapping property; 2) each measurement is mapped to a LUT entry that is used to color each Tree. Mapping limits can be optionally specified\n    \n    **All Methods and Attributes:** See `MultiTreeColorMapper detailed documentation </multitreecolormapper_doc.html>`_.\n    """',
        "SNT": '"""\n    Implements the SNT plugin.\n    \n    **All Methods and Attributes:** See `SNT detailed documentation </snt_doc.html>`_.\n    """',
        "DefaultSearchNode": '"""\n    A SearchNode which can maintain both a from-start and from-goal search state.\n    \n    **All Methods and Attributes:** See `DefaultSearchNode detailed documentation </defaultsearchnode_doc.html>`_.\n    """',
        "PathManagerUI": '"""\n    Implements the Path Manager Dialog.\n    \n    **All Methods and Attributes:** See `PathManagerUI detailed documentation </pathmanagerui_doc.html>`_.\n    """',
        "ConvexHullAnalyzer": '"""\n    Class for Convex Hull measurements of a Tree.\n    \n    **All Methods and Attributes:** See `ConvexHullAnalyzer detailed documentation </convexhullanalyzer_doc.html>`_.\n    """',
        "SNTUtils": '"""\n    Static utilities for SNT\n    \n    **All Methods and Attributes:** See `SNTUtils detailed documentation </sntutils_doc.html>`_.\n    """',
        "MultiViewer2D": '"""\n    Class for rendering montages of Trees as 2D plots that can be exported as SVG, PNG or PDF.\n    \n    **All Methods and Attributes:** See `MultiViewer2D detailed documentation </multiviewer2d_doc.html>`_.\n    """',
        "ConvexHull2D": '"""\n    Computes the convex hull of a set of 2D points.\n    \n    **All Methods and Attributes:** See `ConvexHull2D detailed documentation </convexhull2d_doc.html>`_.\n    """',
        "TreeColorMapper": '"""\n    Class for color coding Trees.\n    \n    **All Methods and Attributes:** See `TreeColorMapper detailed documentation </treecolormapper_doc.html>`_.\n    """',
